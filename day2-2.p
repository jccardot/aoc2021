...
REPEAT:
    IMPORT cDir iUnits.
    CASE cDir:
        WHEN "forward" THEN ASSIGN
            iHoriz = iHoriz + iUnits
            iDepth = iDepth + iAim * iUnits.
        WHEN "down" THEN iAim = iAim + iUnits.
        WHEN "up" THEN iAim = iAim - iUnits.
    END CASE.
END.
INPUT CLOSE.
